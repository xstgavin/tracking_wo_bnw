...
class HomeBrain_Sequence(Dataset):
    ...
    def __init__(self, seq_name=None, vis_threshold=0.0, normalize_mean=[0.485, 0.456, 0.406], normalize_std=[0.229, 0.224, 0.225]):
        ...
        self._mot_dir = osp.join(cfg.DATA_DIR, 'homebrain')
        self._test_folders=['2018-10-01-09-00-22-420620','2018-10-01-09-00-39-420675','2018-10-01-09-02-12-420824',
        ...
        if seq_name:
            assert seq_name in self._test_folders, \
